#!/usr/bin/env python3
# CNN+LSTM — ReLU activations + Huber loss + tuned learning rate (duplicate-dates safe)
...
# Loss & optimizer
HUBER_DELTA    = 1.0
LEARNING_RATE  = 1e-3   # tuned for ReLU
MIN_LR         = 1e-6
PLATEAU_FACTOR = 0.5
PLATEAU_PATIENCE = 4
# ====================================================
...
OUT=Path("./out_relu_huber_lr"); OUT.mkdir(parents=True, exist_ok=True)
...
name="CNN+LSTM(ReLU)+Huber"
print(f"\n[TRAIN] {name} (lr={LEARNING_RATE}) ...")
m=build_cnn_lstm_relu(inp_shape)
