#!/usr/bin/env python3
# CNN+LSTM — Sigmoid activations + Huber loss + tuned learning rate
...
HUBER_DELTA    = 1.0
LEARNING_RATE  = 5e-4   # lower for sigmoid to avoid saturation issues
MIN_LR         = 1e-6
PLATEAU_FACTOR = 0.5
PLATEAU_PATIENCE = 4
# ====================================================
...
OUT=Path("./out_sigmoid_huber_lr"); OUT.mkdir(parents=True, exist_ok=True)
...
name="CNN+LSTM(Sigmoid)+Huber"
print(f"\n[TRAIN] {name} (lr={LEARNING_RATE}) ...")
m=build_cnn_lstm_sigmoid(inp_shape)
